...
import { FormGroup, Label, Input, Button } from "@/styles/pages/main.style";
          ...
          <CommonPageBlockPad className='dark-mode-body'>
            ...
            <Container>
              <div className='help-center-block'>
                ...
                <ChatBoxWrapper className='dark-mode-body-inner'>
                      ...
                      <InfiniteScroll
                        ...
                        {userChats.length > 0 ? (
                          userChats?.map((chat, index) => (
                            <div
                              className='user-detail-list-wrapper'
                              key={index}
                              onClick={() => handleSelectedChat(chat)}>
                              <div className='user-img-dost-wrapper'>
                                <div className='user-img-div'>
                                  <img src={chat?.recipient?.mediumLogo || '/images/user.svg'} alt='blog-img'></img>
                                </div>
                                {chat?.recipient?.onlineStatus && <span className='dost-icon dost-active'></span>}
                              </div>
                              <div className='user-detail-wrapper-div'>
                                <div className='user-detail'>
                                  <h5>{chat?.recipient?.name}</h5>
                                  <p>
                                ...
                                <div className='time-and-date-detail'>
                                  <span>
                                    {chat?.recentMessage?.createdAt && moment(chat?.recentMessage?.createdAt).fromNow()}
                                  </span>
                  ...
                  {selectedChat?.recipient?.address ? (
                    <div className='chat-body-wrapper'>
                      <form
                        ...
                        <div className='chat-body-header-wrapper'>
                          <div className='chat-user-header pointer' onClick={()=>handleUserRoute(selectedChat?.recipient?.name)}>
                            <div className='user-img-div'>
                              <img src={selectedChat?.recipient?.mediumLogo || '/images/user.svg'} alt='blog-img'></img>
                            </div>
                            <div className='user-detail'>
                              <h5>{selectedChat?.recipient?.name || 'NoName'}</h5>
                              {selectedChat?.recipient?.onlineStatus && (
                                <p>
                                  <i className='dost-icon dost-active'></i>
                                  Online
                                </p>
                              )}
                            </div>
                            ...
                            <InfiniteScroll
                              ...
                              {messages.length > 0 &&
                                messages.map((message, index) => (
                                  <div
                                    className={`user-message-list-div ${
                                      message?.sender === account ? 'right-side-user' : ''
                                    }`}
                                    key={index}>
                                    {message?.sender !== account ? (
                                      <div>
                                        <div className='user-imgdiv'>
                                          <img
                                            src={selectedChat?.recipient?.mediumLogo || '/images/user.svg'}
                                            alt='blog-img'></img>
                                        </div>
                                      </div>
                                    ) : (
                        ...
                        <div className='chat-footer-wrapper-div'>
                          ...
                          <div className='chat-textarea-wrapper'>
                            ...
                            type="text"
                              ...
                              name='message'
                              value={newMessage}
                              onChange={handleInputMessage}></input>
                            <button type='submit' className='send-icon' disabled={isSending} >
                              <svg
                                width='56'
                                height='56'
                                viewBox='0 0 56 56'
                    ...
                    <div className='d-flex justify-content-center align-items-center w-100'>
                      Select chat to show Conversation here...
                    </div>
                  )}
                </ChatBoxWrapper>
              </div>
