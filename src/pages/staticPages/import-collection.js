...
import { FormGroup, Label, Input, UploadFillDivWrapper, Image } from '@/styles/pages/main.style';
        ...
        <Container>
          <div className='help-center-block'>
            <div className='help-center-block-title'>
              ...
              <p>
                Our unique import function effortlessly transitions your beloved collections from Ethereum, readying
                them for the vibrant trading possibilities on PulseChain.
              </p>
            </div>
                  ...
                  <div className='TX-choose-blockchain-wrapper'>
                    <div className='TXtype-details-wrapper'>
                      <div className='TXtype-details-wrapper-file'>
                        <label>
                          Upload Logo Here <span>(400*400)</span>
                        </label>
                        <UploadFillDivWrapper className='upload-logo-part'>
                          <input className='file-input' type='file' name='mainFile' />
                          <div className='uploadfiletext'>
                            <svg
                              ...
                              <path
                                d='M14.9168 25.334V8.35482L9.50017 13.7715L6.5835 10.7507L17.0002 0.333984L27.4168 10.7507L24.5002 13.7715L19.0835 8.35482V25.334H14.9168ZM4.50017 33.6673C3.35433 33.6673 2.37308 33.259 1.55642 32.4423C0.739749 31.6257 0.332111 30.6451 0.3335 29.5007V23.2507H4.50017V29.5007H29.5002V23.2507H33.6668V29.5007C33.6668 30.6465 33.2585 31.6277 32.4418 32.4444C31.6252 33.2611 30.6446 33.6687 29.5002 33.6673H4.50017Z'
                                fill='black'
                              />
                            </svg>
                            <div className='uploadfile-detail'>
                              <h3>Drag your item to upload</h3>
                              <span>PNG, GIF, WebP, MP4 or MP3. Maximum file size 100 Mb.</span>
                              <Button isBorderBtn={true}>Choose File</Button>
                            </div>
                          </div>
                      ...
                      <div className='TXtype-details-wrapper-file'>
                        <label>
                          Upload Cover Image here <span>(1600*400)</span>
                        </label>
                        <UploadFillDivWrapper className='upload-logo-part'>
                          <input className='file-input' type='file' name='mainFile' />
                          <div className='uploadfiletext'>
                      ...
                      <FormGroup>
                        ...
                        <Input type='type' placeholder='e.g. Collection Address here ' />
                      </FormGroup>
                      <FormGroup>
                      ...
                      <FormGroup>
                        ...
                        <Input as='textarea' placeholder='Message' rows={6} />
                      </FormGroup>
                      <FormGroup>
