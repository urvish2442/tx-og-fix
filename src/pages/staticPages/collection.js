...
const profilepage = () => {
    ...
    return (
        <CommonPageBlockPad className="no-container-padding">
            ...
            <div className="top-collection-block">
                <div className="top-banner-main">
                    <img
                        src={"../../images/banner-collection.png"}
                        alt=""
                    ></img>
                </div>
            ...
            <div className="name-details-block">
                <div className="name-details-block-left">
                    ...
                    <div className="name-details-text">
                        <p>
                            Created by <strong>Simon</strong>
                        </p>
                        <p>
                            Royalties <span className="high-block">15.69%</span>
                        </p>
                    ...
                    <p className="last-text">
                        9,999 Captainz, with their pirate crewz, explore the
                        Broken Seas in search of the legendary treasure known as
                        “<strong>BigBoss</strong>”. Join them in their quests
                        for glory, fortune, love, and of course… memes.
                    </p>
                </div>
                <div className="name-details-block-right">
                    <div className="name-details-block-right-inner">
                        <div className="name-details-block-right-date">
                            <p>
                                <span>Floor</span> <span>5.315 PLS</span>
                            </p>
                            <p>
                                <span>Volume</span> <span>5.315 PLS</span>
                            </p>
                            <p>
                                <span>Items</span> <span>10K</span>
                            </p>
                            <p>
                        ...
                        <div className="name-details-block-right-date">
                            <p>
                                <span>Blockchain</span> <span>PulseChain</span>
                            </p>
