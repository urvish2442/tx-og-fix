          ...
          <div className='help-center-block'>
            ...
            <div className='terms-condition-block'>
              ...
              <div className='terms-condition-block-content'>
                ...
                <p>
                  By accessing or using [Your Crypto Website] (hereinafter referred to as "the Website"), you agree to
                ...
                <p>2.2 You must be of legal age in your jurisdiction to use the services provided by the Website.</p>
                <h4>3. Use of Services</h4>
                <p>
                  3.1 [Your Crypto Website] provides services related to cryptocurrency. Users must adhere to all
                  applicable laws and regulations.
                </p>
                <p>
                  3.2 The Website reserves the right to modify, suspend, or discontinue any aspect of the services at
                  any time.
                </p>
                <h4>4. Risks</h4>
                <p>
                  4.1 Cryptocurrency investments involve risk. Users are solely responsible for assessing and assuming
                  the risks associated with cryptocurrency transactions.
                </p>
                <p>
                  4.2 [Your Crypto Website] does not provide financial advice. Users should conduct their own research
                  or consult with a qualified financial advisor.
                </p>
                <h4>5. Privacy Policy</h4>
                <p>
                  The Website's Privacy Policy governs the collection, use, and disclosure of user information. By using
                  the Website, you agree to the terms outlined in the Privacy Policy.
                </p>
                <h4>6. Intellectual Property</h4>
                <p>
                  All content on the Website is the intellectual property of [Your Company]. Users may not reproduce,
                  distribute, or use any content without prior written permission.
                </p>
                <h4>7. Limitation of Liability</h4>
                <p>
                  7.1 [Your Company] is not liable for any direct, indirect, incidental, special, or consequential
                  damages arising from the use of the Website.
                </p>
                <p>
                  7.2 Users agree to indemnify and hold [Your Company] harmless from any claims or liabilities arising
                  out of their use of the Website.
                </p>
                ...
                <p>By using [Your Crypto Website], you acknowledge that you have read, understood, and agree to these Terms and Conditions. These terms may be</p>
              </div>
            </div>
          </div>
        </Container>
