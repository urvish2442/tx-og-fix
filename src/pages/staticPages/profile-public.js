                ...
                <div className='profile-inner-flex-left'>
                  ...
                  <div className='list-block-inner'>
                    ...
                    <div className='list-block-inner-left border-left-main'>
                      <h3>
                        <img src={'../../images/icon-total-table.png'} alt='icon-img'></img>
                        <span>17K</span>
                      </h3>
                      <p>Est Value</p>
                    </div>
                  ...
                  <div className='block-text-last'>
                    <p>
                      Passionate about the cutting-edge world of NFTs, I am a dedicated PulseChain NFT collector. With a
                      keen eye for rarity and potential, I traverse the vibrant PulseChain ecosystem, curating a unique
                      and diverse collection. My portfolio spans from groundbreaking art pieces to utility-driven
                      assets, each chosen for its ability to redefine the boundaries of digital ownership and
                      creativity. Beyond collecting, I'm deeply involved in the PulseChain community, participating in
                      discussions, sharing insights, and supporting up-and-coming creators. I believe in the
                      transformative power of blockchain and its ability to democratize art and investment, making them
                      accessible to all
                    </p>
                  </div>
                </div>
            ...
            <div className='listed-tab-block'>
              <div className='listed-tab-block-inner'>
                <div className='listed-tab-block-inner-button'>
                  <button className='list-btn '>Listed</button>
                </div>
                <div className='listed-tab-block-inner-button'>
                  <button className='list-btn '>Unlisted</button>
                </div>
              </div>
