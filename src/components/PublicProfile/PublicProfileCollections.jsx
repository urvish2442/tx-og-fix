import { usePublicProfileCollections } from "@/hooks/useFetchHooks";
...
const PublicProfileCollections = ({
    ...
    const {
        ...
        handlePageChange,
        handleSearch,
    } = usePublicProfileCollections({ ownerAddress });
    return (
        <>
...
export default PublicProfileCollections;
