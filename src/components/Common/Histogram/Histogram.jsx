...
class Histogram extends Component {
    ...
    normalizeData = (data) => {
        ...
        sortedData.forEach((data) => {
            normalizedData.push({
                ...data,
                normalizedValue: normalizedValue * 0.66 * data.id,
            });
        });
    ...
    handleButtonMovement = ({ clientX }, btn_id) => {
        ...
        // console.log('clientX barMinLocation', barMinLocation+(this.buttonWidth / 2)+sliderContainerLeftPosition)
        // console.log('clientX barMaxLocation', barMaxLocation+(this.buttonWidth / 2)+sliderContainerLeftPosition)
        ...
        if (normalizedData.length > 0) {
            if (
                ...
                let currentPos =
                    ...
                    sliderContainerLeftPosition -
                    this.buttonWidth / 2;
                let findInputValue = this.findInputValueFromButtonLocation(
                    clientX - sliderContainerLeftPosition,
                    btn_id
                );
                if (btn_id === "Min") {
                    if (currentPos < barMaxLocation) {
                        this.setState(
                            {
                                barMinLocation:
                                    currentPos > barMaxLocation
                                        ? barMaxLocation
                                        : currentPos,
                                leftInputValue:
                                    findInputValue > rightInputValue
                                        ? rightInputValue
                                        : findInputValue,
                            },
                            () => this.getBoundries()
                    ...
                    //     this.setState(
                    //         {
                    //             barMinLocation: barMaxLocation,
                    //             leftInputValue: this.rightInputValue,
                    //         },
                    //         () => this.getBoundries()
                    //     );
                    ...
                    if (currentPos > barMinLocation) {
                        // console.log('findInputValue', findInputValue, "leftInputValue", leftInputValue, "currentPos", currentPos, "barMinLocation", barMinLocation)
                        this.setState(
                            {
                                barMaxLocation:
                                    currentPos < barMinLocation
                                        ? barMinLocation
                                        : currentPos,
                                rightInputValue:
                                    findInputValue < leftInputValue
                                        ? leftInputValue
                                        : findInputValue,
                            },
                            () => this.getBoundries()
                    ...
                    //     this.setState(
                    //         {
                    //             barMaxLocation: barMinLocation,
                    //             rightInputValue: this.leftInputValue,
                    //         },
                    //         () => this.getBoundries()
                    //     );
                    // }
                ...
                //                 this.buttonWidth / 2,
                //             leftInputValue:
                //                 this.findInputValueFromButtonLocation(
                //                     clientX - sliderContainerLeftPosition,
                //                     btn_id
                //                 ),
                //         },
    ...
    barContainerVerticalAdjust = () => {
        ...
        if (this.state.normalizedData.length > 0) {
            ...
            let diff = this.histogram.current.offsetHeight - 0;
            return `${diff}px`;
        }
    };
            ...
            <div className="histogramComponent">
                ...
                <div className="d-flex justify-content-center">
                    <span className="mx-2 fw-semibold">
                        {usdFormatter.format(this.state.leftInputValue || 0)}
                    </span>
                    -
                    <span className="mx-2 fw-semibold">
                        {usdFormatter.format(this.state.rightInputValue || 0)}
                    </span>
                </div>
