...
//                             <h5 className="diff-padding-block">
//                                 {item?.collectionName}
//                             </h5>
//                             <p>Collection</p>
//                         </div>
...
//                             ></img>
//                             <span>
//                                 {CountParser(item?.latestBid || 0, 4)}{" "}
//                                 {item?.symbol}
//                             </span>
//                         </h5>
//                     </div>
...
const AuctionCard = ({
    ...
    return (
        <div className="common-product-block-inner new-card-block hover:translate-y-[-3px] transition-all ease-in !cursor-pointer">
            <div className="common-product-block-inner-width !rounded-[22px]" onClick={handleRouteChange}>
