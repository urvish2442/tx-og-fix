import { useAllAchievements } from "@/hooks/useFetchHooks";
...
const AchievementsComponent = () => {
    const { loading, data, hasMore, count, page, handlePageChange } =
        useAllAchievements();
    return (
      <>
        {loading && page == 1 ? (
                ...
                <div className='reward-block-main-inner'>
                  <div className='reward-block-top'>
                    ...
                    <div className='reward-block-top-inner'>
                      ...
                      <div className='reward-points-block'>
                        <h4>{(data?.remaining?.length || 0) + (data?.achieved?.length || 0)}</h4>
                      </div>
                    </div>
                    <div className='reward-block-top-inner'>
                      <h3>
                      ...
                      <div className='reward-points-block reward-points-block-last'>
                        <h5 className='mt-top'>
                          <span>{data?.remaining?.length || 0}</span>
                        </h5>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className='achievement-block'>
                      ...
                      <div className='achievement-block-inner'>
                        {data?.achieved?.length > 0 ? (
                          <>
                            {data?.achieved?.map((item, index) => (
                              <div className='achievement-block-inner-block' key={index}>
                                <img src={item?.image || '../../images/achivement-icon.png'} alt='achivement-img'></img>
                                <h3>{item?.name || ''}</h3>
